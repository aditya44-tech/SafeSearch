...
export async function POST(
  ...
  // Hazard category stays a real category (e.g. Fire/Explosion). When the text has
  // a hot-work context, look up the hot-work standard (OISD-STD-227) so only the
  // related standard is mapped.
